...
# 設定一覧
**他modと併用した際、設定に不具合があった場合はその設定をオフにしてください**  
| **設定名** ||
|---|---|
| [コード隠し](#コード隠し) | [ロビータイマー](#ロビータイマー) |
| [ランダムマップ](#ランダムマップ) | [虹色の帽子](#虹色の帽子) |
| [虹色のバイザー](#虹色のバイザー) | [虹色の名前](#虹色の名前) |
| [半透明の名前](#半透明の名前) | [虹色のアウトライン](#虹色のアウトライン) |
| [クルー色のアウトライン](#クルー色のアウトライン) | [虹色のベント](#虹色のベント) |
| [クルー色のベント](#クルー色のベント) | [偽のレベル](#偽のレベル) |
| [ネームプレート非表示](#ネームプレート非表示) | [拡大縮小機能](#拡大縮小機能) |
| [特定の機種を追い出す](#特定の機種を追い出す) | [参加者にチャットを送る](#参加者にチャットを送る) |
...
[チャットコマンド](#チャットコマンド)あり
## 虹色のアウトライン
キル対象クルーのアウトラインを虹色にします。
## クルー色のアウトライン
キル対象クルーのアウトラインをキル対象の色にします。
## 虹色のベント
ベント周りを虹色にします。
## クルー色のベント
ベント周りを自身の色にします。
...
[チャットコマンド](#チャットコマンド)あり
## 参加者にチャットを送る
プレイヤーが入ってきた時に、入ってきた本人だけが見えるチャットを送信します。
[チャットコマンド](#チャットコマンド)あり
## 二段の名前
ロビーでの名前に二段目を追加します。
[チャットコマンド](#チャットコマンド)あり
...
参加時にコードをコピーします。
## 名前のアウトライン
[虹色の名前](#虹色の名前)か[半透明の名前](#半透明の名前)が有効時にアウトラインの色を変更します。
## キーコマンド
キーコマンド(チャットのコピペや取り消しなど)をオンオフできます。
## 部屋設定の拡張
マップ選択やタスク範囲の上限突破をオフにできます。
## 0.00001秒のキルクール
キルクールを0.00001にできます。
## CPS
一秒間のクリック回数を測れます。  
...
| **フリープレイ時のみ** |
|`/Tpme [名前]`|指定した人を自分にテレポートさせます|
|`/Kill [名前]`|指定した人をキルします|
|`/Exiled [名前]`| 指定した人を追放します|
|`/Revive [名前]`| 指定した人を生きかえらせます|
| **[コード隠し](#コード隠し)有効時のみ** |
|`/ChangeLobbyCode(CLC) [コード名]`|ロビーコードの名前を変更できます|
...
|初期設定の項目の削除|
|マップ変更項目の追加|
|タスク/キルクールの値を<br>0~180に変更できるように変更|
|キルクール0時にキルクールを<br>0.00001秒にするように変更|
|廃村機能の追加|`Shiht`+`L`+`Enter`|
|自動でコードを貼り付ける機能|参加ボタンを押す|
|フリープレイ時のチャット常時有効化|
|スタートボタンの常時有効化|
|スタートボタンを押した時に<br>中断したり即スタートする機能|中断`C`<br>即スタート`Shift`|
|チャットの全消し機能|`Shift`+`BackSpace`|
|チャットの戻す機能|`Control`+`Z`|
|チャットの取り消し機能|`Control`+`Y`|
|チャットのコピー機能|`Control`+`C`|
